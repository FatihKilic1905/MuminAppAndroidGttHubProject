...
public class GunesBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentGunes) {
        ...
        String title = intentGunes.getStringExtra("vGunesTitle");
        String description = intentGunes.getStringExtra("vGunesDescription");
        String sound = intentGunes.getStringExtra("vGunesSound");
        int notifyNum = intentGunes.getIntExtra("vGunesNotifyNum",0);
        String vaktinAyetiStr = intentGunes.getStringExtra("vaktinAyeti");
        String vaktinHadisiStr = intentGunes.getStringExtra("vaktinHadisi");
