...
public class AksamBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentAksam) {
        ...
        String title = intentAksam.getStringExtra("AksamNotTitle");
        String description = intentAksam.getStringExtra("AksamNotDescription");
        String sound = intentAksam.getStringExtra("AksamNotSound");
        int notifyNum = intentAksam.getIntExtra("AksamNotNotifyNum",0);
