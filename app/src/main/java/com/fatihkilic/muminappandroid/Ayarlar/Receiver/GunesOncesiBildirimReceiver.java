...
public class GunesOncesiBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentGunesOncesi) {
        ...
        String title = intentGunesOncesi.getStringExtra("vOGunesTitle");
        String description = intentGunesOncesi.getStringExtra("vOGunesDescription");
        String sound = intentGunesOncesi.getStringExtra("vOGunesSound");
        int notifyNum = intentGunesOncesi.getIntExtra("vOGunesNotifyNum",0);
