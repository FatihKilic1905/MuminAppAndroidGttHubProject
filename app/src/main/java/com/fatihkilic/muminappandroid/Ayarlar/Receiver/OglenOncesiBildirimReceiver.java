...
public class OglenOncesiBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentOgleOncesi) {
        ...
        String title = intentOgleOncesi.getStringExtra("vOOgleTitle");
        String description = intentOgleOncesi.getStringExtra("vOOgleDescription");
        String sound = intentOgleOncesi.getStringExtra("vOOgleSound");
        int notifyNum = intentOgleOncesi.getIntExtra("vOOgleNotifyNum",0);
