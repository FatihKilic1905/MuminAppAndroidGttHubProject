...
public class AksamOncesiBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentAksamOncesi) {
        ...
        String title = intentAksamOncesi.getStringExtra("vOAksamTitle");
        String description = intentAksamOncesi.getStringExtra("vOAksamDescription");
        String sound = intentAksamOncesi.getStringExtra("vOAksamSound");
        int notifyNum = intentAksamOncesi.getIntExtra("vOAksamNotifyNum",0);
