...
public class YatsiOncesiBildirimReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentYatsiOncesi) {
        ...
        String title = intentYatsiOncesi.getStringExtra("vOYatsiTitle");
        String description = intentYatsiOncesi.getStringExtra("vOYatsiDescription");
        String sound = intentYatsiOncesi.getStringExtra("vOYatsiSound");
        int notifyNum = intentYatsiOncesi.getIntExtra("vOYatsiNotifyNum",0);
