...
public class ModelKuraniKerimTurkceDib {

    public Integer juzTrDib;
    ...
    public ModelKuraniKerimTurkceDib(Integer juzTrDib, Integer numberTrDib, Integer numberInSurahTrDib, Integer pageTrDib, Integer sajdaTrDib, String surahNameTrDib, String surahNumberTrDib, String textTrdib) {
        ...
        this.pageTrDib = pageTrDib;
        this.sajdaTrDib = sajdaTrDib;
        this.surahNameTrDib = surahNameTrDib;
        this.surahNumberTrDib = surahNumberTrDib;
        this.textTrdib = textTrdib;
    }
}
